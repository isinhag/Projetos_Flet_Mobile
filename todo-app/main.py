...
class AppToDo:
    def __init__(self, page: ft.Page):
        # Incializa o aplicativo com a página Flet e configura as configurações iniciais
        self.page = page 
    ...
    def configurar_pagina(self):
        ...
        self.page.vertical_alignment = ft.MainAxisAlignment.START # Define o tema escuro
    ...
    def criar_abas(self):
        # Criar as abas para filtrar as tarefas (Todas, Pendentes, Concluídas)
        self.abas = ft.Tabs(
            selected_index=0,
    ...
    def criar_lista_tarefas(self):
        # Criar o container para a lista de tarefas
...
if __name__ == "__main__":
    ft.app(target=AppToDo) # Inicia o aplicativo Flet com a classe App